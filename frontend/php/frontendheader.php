							...
							<li class="dropdown-submenu">
								...
								<ul class="dropdown-menu">
									...
									foreach ($subcategories as $subcategory) {
										...
										<li><a class="dropdown-item" href="subcategory.php?id=<?= $scid ?>"> <?= $scname; ?> </a></li>
				...
				<div class="hov-dropdown d-inline-block">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown2">
						...
						foreach ($brands as $brand) {
							...
							$bname = $brand['name'];	
							?>
							<a class="dropdown-item" href="brands.php?id=<?= $bid ?>"> <?= $bname ?> </a>
							<div class="dropdown-divider"></div>
						<?php } ?>
					</div>
		...
		<div class="mt-3">
			...
			<div class="collapse sidebardropdown_container_category mt-3" id="category<?= $cid ?>">
            	...
            	?>
			    	...
			    	<a href="subcategory.php?id=<?= $scid ?>" class="py-2"> <?= $scname; ?> </a>
