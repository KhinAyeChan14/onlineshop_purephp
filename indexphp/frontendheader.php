...
<body>
	...
	?>
		...
		<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
		    ...
		    <a class="dropdown-item" href="frontend/orderhistory.php">
		    	Order History
		    </a>
		  	<div class="dropdown-divider"></div>
		    ...
		    <a class="dropdown-item" href="frontend/signOut.php">
		    	Logout
		    </a>
		</div>
	...
	<?php } else{  ?>
		...
		<a href="frontend/login.php" class="d-xl-block d-lg-block d-md-block d-none  text-decoration-none loginLink float-right"> Login | Sign-up </a>
...
<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
	...
	<a href="frontend/shoppingcart.php" class="text-decoration-none d-xl-inline d-lg-inline d-md-inline d-sm-none d-none shoppingcartLink"> 
		<i class="icofont-shopping-cart"></i> 
		<span class="badge badge-pill badge-light badge-notify cartNotistyle cartNoti"> 1 </span>
		<span class="total"></span>
	</a>

	<a href="frontend/shoppingcart.php" class="text-decoration-none d-xl-none d-lg-none d-md-none d-sm-inline-block d-inline-block shoppingcartLink"> 
		<i class="icofont-shopping-cart"></i>
		<span class="badge badge-pill badge-light badge-notify cartNotistyle cartNoti"> 1 </span>
	</a>
...
<div class="container subNav d-xl-block d-lg-block d-none my-3">
						...
						<li class="dropdown-submenu">
							...
							<ul class="dropdown-menu">
								...
								foreach ($subcategories as $subcategory) {
									...
									<li><a class="dropdown-item" href="frontend/subcategory.php?id=<?= $scid ?>"> <?= $scname; ?> </a></li>
				...
				<div class="hov-dropdown d-inline-block">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown2">
						...
						foreach ($brands as $brand) {
							...
							$bname = $brand['name'];	
							?>
							<a class="dropdown-item" href="frontend/brands.php?id=<?= $bid ?>"> <?= $bname ?> </a>
							<div class="dropdown-divider"></div>
						<?php } ?>
					</div>
	...
	<div id="mySidebar" class="sidebar">
		...
		<div class="mt-3">
			...
			foreach ($categories as $category) {
				...
				<div class="collapse sidebardropdown_container_category mt-3" id="category<?= $cid ?>">
					...
					foreach ($subcategories as $subcategory) {
						...
						<a href="frontend/subcategory.php?id=<?= $scid?>" class="py-2"> <?= $scname; ?> </a>
			...
			<a href="frontend/login.php"> Login | Signup</a>
			<hr>

			<a href="frontend/shoppingcart.php"> Cart [ <span class="cartNoti">1</span> ] <span class="total"></span> </a>
			<hr>

			<img src="../frontend/image/download.png" class="img-fluid ml-2 text-center" style="width: 150px">
			<hr>

			<p class="text-white ml-3"> Copyright &copy; <img src="logo/logo_wh_transparent.png" style="width: 20px; height: 20px"> 2020  </p>
